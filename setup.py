...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "LittleFighter"

        #Project url
        self.project_url = "www.github.com/shivamshekhar"
        ...
        #Auhor of program
        self.author_name = "Shivam Shekhar"
        self.author_email = "shivam.shekhar.ece14@itbhu.ac.in"
        self.copyright = "Copyright (c) 2016 Shivam Shekhar."

        #Description
        self.project_description = "A recreated version of Little Fighter 2."
